...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ADI_TMC2209_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZEPHYR_GPIO_STEP_DIR_STEPPER_CTRL_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_STACK_SIZE, 25000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MICROROS_TRANSPORT_SERIAL_USB, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STEPPER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STEPPER_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STEPPER_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STEPPER_INIT_PRIORITY, 90);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STEPPER_ADI_TMC2209, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STEPPER_CTRL_EVENT_HANDLER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STEPPER_CTRL_ISR_SAFE_EVENTS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STEPPER_CTRL_EVENT_QUEUE_LEN, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_STEPPER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GPIO_STEPPER_COUNTER_TIMING, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STEPPER_GPIO_STEP_DIR_STEPPER_CTRL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STEP_DIR_STEPPER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_VID, 0x0483);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x5740);
