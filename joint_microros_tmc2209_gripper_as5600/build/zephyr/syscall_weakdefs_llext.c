...
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_stepper_ctrl_configure_ramp;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_stepper_ctrl_get_actual_position;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_stepper_ctrl_is_moving;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_stepper_ctrl_move_by;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_stepper_ctrl_move_to;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_stepper_ctrl_run;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_stepper_ctrl_set_event_cb;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_stepper_ctrl_set_microstep_interval;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_stepper_ctrl_set_reference_position;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_stepper_ctrl_stop;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_stepper_disable;
...
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_stepper_set_event_cb;
